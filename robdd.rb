...
class ROBDD
  ...
  def build_func(_func, i, num_of_vars)
    ...
    if i > num_of_vars
      ...
      v0 = build_func(function_set_var_val(DeepClone.clone(func), i,0,num_of_vars),i+1,num_of_vars)

      puts "Calling v1:"
      puts "i is: #{i.inspect}"
      puts "func: #{func.inspect}"
      v1 = build_func(function_set_var_val(DeepClone.clone(func), i,1,num_of_vars),i+1,num_of_vars)
